...
public abstract class FactorioRconGlobals
{
  ...
  /// <summary>
  /// `localised_print()` allows printing <see cref="LocalisedString)ToStdoutWithoutPollutingTheFactorio[LogFile](Https://Wiki.Factorio.Com/LogFile" />. This is primarily useful when communicating with external tools that launch Factorio as a child process.
  /// </summary>
  ...
  /// <summary>
  /// `log()` can print <see cref="LocalisedString)ToTheFactorio[LogFile](Https://Wiki.Factorio.Com/LogFile).This,InCombinationWithTheSerpentLibrary,MakesDebuggingInTheDataStageEasierBecauseItAllowsTheInspectionOfEntirePrototypeTables.ForExample,PrintingAllPropertiesOfTheSulfurItemPrototypeCanBeDoneLikeSo:`Log(Serpent.Block(Data.Raw["Item"]["Sulfur"])" />`
  /// </summary>
  /// <param name="@string">Lua name: string</param>
