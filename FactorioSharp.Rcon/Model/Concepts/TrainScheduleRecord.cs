...
public class TrainScheduleRecord
{
  ...
  /// <summary>
  ///     When a train is allowed to reach rail target from any direction it will be `nil`. If rail has to be reached from specific direction, this value allows to choose the direction.
  ///     This value corresponds to <see cref="LuaEntity.ConnectedRailDirection" /> of a TrainStop.
  /// </summary>
