...
public abstract class LuaControl : LuaObject
{
  ...
  ///     This is the GUI that will asked to close (by firing the <see cref="OnGuiClosed)Event" /> when the `Esc` or `E` keys are pressed. If this attribute is not `nil`, and a new GUI
  ///     is written to it, the existing one will be asked to close.
  /// </summary>
  [FactorioRconAttribute("opened")]
    public Union2139524675 Opened { get; set; }
  ...
  [FactorioRconAttribute("walking_state")]
    public Table1903244290 WalkingState { get; set; }
  ...
  [FactorioRconAttribute("mining_state")]
    public Table1408680011 MiningState { get; set; }

  /// <summary>
  ///     Current shooting state.
  /// </summary>
  [FactorioRconAttribute("shooting_state")]
    public Table1093008433 ShootingState { get; set; }
  ...
  [FactorioRconAttribute("repair_state")]
    public Table1492839715 RepairState { get; set; }
  ...
  [FactorioRconAttribute("cheat_mode")]
    ...
    /// <summary>
    ///     Modifies the running speed of this character by the given value as a percentage. Setting the running modifier to `0.5` makes the character run 50% faster. The minimum value of
    ///     `-1` reduces the movement speed by 100%, resulting in a speed of `0`.
    /// </summary>
    ...
    ///     You can also pass 1 or 2 numbers as the parameters and they will be used as relative teleport coordinates `'teleport(0, 1)'` to move the entity 1 tile positive y.
    ///     `'teleport(4)'` to move the entity 4 tiles to the positive x.
    ...
    public abstract uint GetCraftableCount(Union959413196 recipe);
    ...
    public abstract uint BeginCrafting(uint count, Union959413196 recipe, bool? silent = null);
    ...
    ///     Note that both this method and <see cref="LuaControl.GetBlueprintEntities" /> refer to the currently selected blueprint, meaning a blueprint book with a selected blueprint
    ///     will return the information as well.
    /// </summary>
