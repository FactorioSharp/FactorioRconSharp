...
public abstract class LuaSettings : LuaObject
{
  ...
  /// <summary>
  ///     Gets the current per-player settings for the given player, indexed by prototype name. Returns the same structure as <see cref="LuaPlayer.ModSettings" />. This table becomes
