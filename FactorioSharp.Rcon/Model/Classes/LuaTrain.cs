...
public abstract class LuaTrain : LuaObject
{
  ...
  [FactorioRconAttribute("locomotives")]
    public Table351806888 Locomotives { get; private set; }
  ...
  [FactorioRconAttribute("back_rail")]
    ...
    /// <summary>
    ///     The front stock of this train, if any. The front of the train is in the direction that a majority of locomotives are pointing in. If it's a tie, the North and West directions
    ///     take precedence.
    /// </summary>
