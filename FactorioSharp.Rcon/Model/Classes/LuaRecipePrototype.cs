...
public abstract class LuaRecipePrototype : LuaObject
{
  ...
  [FactorioRconAttribute("localised_name")]
    ...
    /// <summary>
    ///     The multiplier used when this recipe is copied from an assembling machine to a requester chest. For each item in the recipe the item count * this value is set in the requester
    ///     chest.
    /// </summary>
