...
public abstract class LuaEquipmentGridPrototype : LuaObject
{
  ...
  [FactorioRconAttribute("order")]
    ...
    /// <summary>
    ///     Equipment category names for the <see cref="LuaEquipmentPrototype.EquipmentCategories" /> that may be inserted into this equipment grid. The grid will accept any equipment
    ///     that has at least one category in this list.
    /// </summary>
