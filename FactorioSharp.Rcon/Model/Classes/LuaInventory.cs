...
public abstract class LuaInventory : LuaObject
{
  ...
  /// </summary>
  /// <remarks>
  ///     "Supporting a bar" doesn't mean that the bar is set to some nontrivial value. Supporting a bar means the inventory supports having this limit at all. The character's inventory
  ///     is an example of an inventory without a bar; the wooden chest's inventory is an example of one with a bar.
  /// </remarks>
  ...
  [FactorioRconMethod("set_filter")]
    public abstract bool SetFilter(uint index, Union1109066428 filter);
  ...
  /// </summary>
  /// <remarks>
  ///     This is a "best guess" number; things like assembling machine filtered slots, module slots, items with durability, and items with mixed health will cause the result to be
  ///     inaccurate.
