...
/// <summary>
///     An element of a custom GUI. This type is used to represent
///     <see
///         cref="LuaEntity),DifferentKindsOfElementsSupportDifferentAttributes;AttemptingToAccessAnAttributeOnAnElementThatDoesn'TSupportIt(ForInstance,TryingToAccessThe`ColumnCount`OfA`Textfield`" />
///     will result in a runtime error.
///     For information on all supported GUI elements, see <see cref="GuiElementType" />.
///     Each GUI element allows access to its children by having them as attributes. Thus, one can use the `parent.child` syntax to refer to children. Lua also supports the
///     `parent["child"]` syntax to refer to the same element. This can be used in cases where the child has a name that isn't a valid Lua identifier.
/// </summary>
/// <examples>
///     <list type="bullet">
///         <item>
...
public abstract class LuaGuiElement : LuaObject
{
  ...
  /// <summary>
  ///     The style of this element. When read, this evaluates to a <see cref="LuaStyle).ForWriting,ItOnlyAcceptsAStringThatSpecifiesTheTextualIdentifier(PrototypeName" /> of the
  ///     desired style.
  /// </summary>
  [FactorioRconAttribute("style")]
    public Union1028307656 Style { get; set; }
  ...
  /// <summary>
  ///     Related to the number to be shown in the bottom right corner of this sprite-button. When set to `true`, numbers that are non-zero and smaller than one are shown as a
  ///     percentage rather than the value. For example, `0.5` will be shown as `50%` instead.
  /// </summary>
  ...
  [FactorioRconAttribute("elem_value")]
    public Union588187751 ElemValue { get; set; }
  ...
  [FactorioRconMethod("add")]
    public abstract LuaGuiElement Add(
        GuiElementType type,
        string? name = null,
        LocalisedString? caption = null,
        LocalisedString? tooltip = null,
        ElemID? elemTooltip = null,
        bool? enabled = null,
        bool? visible = null,
        bool? ignoredByInteraction = null,
        string? style = null,
        Tags? tags = null,
        uint? index = null,
        GuiAnchor? anchor = null,
        GameControllerInteractionEnum? gameControllerInteraction = null,
        bool? raiseHoverEvents = null
    );
  ...
  [FactorioRconMethod("scroll_to_element")]
    public abstract void ScrollToElement(LuaGuiElement element, Literals1299321874? scrollMode = null);
  ...
  [FactorioRconMethod("scroll_to_item")]
    public abstract void ScrollToItem(int index, Literals92543650? scrollMode = null);
