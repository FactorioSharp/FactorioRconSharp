...
public abstract class LuaFluidPrototype : LuaObject
{
  ...
  [FactorioRconAttribute("name")]
    ...
    /// <summary>
    ///     A multiplier on the amount of emissions produced when this fluid is burnt in a generator. A value above `1.0` increases emissions and vice versa. The multiplier can't be
    ///     negative.
    /// </summary>
    ...
    /// <summary>
    ///     The amount of energy in Joules one unit of this fluid will produce when burnt in a generator. A value of `0` means this fluid can't be used for energy generation. The value
    ///     can't be negative.
    /// </summary>
