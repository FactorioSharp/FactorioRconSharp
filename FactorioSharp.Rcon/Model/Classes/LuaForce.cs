...
/// <summary>
///     `LuaForce` encapsulates data local to each "force" or "faction" of the game. Default forces are player, enemy and neutral. Players and mods can create additional forces (up to
///     64 total).
/// </summary>
...
public abstract class LuaForce : LuaObject
{
  ...
  [FactorioRconAttribute("manual_crafting_speed_modifier")]
    ...
    /// <summary>
    ///     Enables some higher-level AI behaviour for this force. When set to `true`, biters belonging to this force will automatically expand into new territories, build new spawners,
    ///     and form unit groups. By default, this value is `true` for the enemy force and `false` for all others.
    /// </summary>
    ...
    /// <summary>
    ///     Modifies the running speed of all characters in this force by the given value as a percentage. Setting the running modifier to `0.5` makes the character run 50% faster. The
    ///     minimum value of `-1` reduces the movement speed by 100%, resulting in a speed of `0`.
    /// </summary>
    ...
    ///     To write to this, the entire table must be written. Providing an empty table or `nil` will empty the research queue and cancel the current research. Writing to this when the
    ///     research queue is disabled will simply set the last research in the table as the current research.
    /// </summary>
    ...
    /// <summary>
    ///     Custom color for this force. If specified, will take priority over other sources of the force color. Writing nil clears custom color. Will return nil if it was not specified
    ///     or if was set to {0,0,0,0}
    /// </summary>
