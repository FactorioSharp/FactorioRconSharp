...
/// <summary>
///     A lazily loaded value. For performance reasons, we sometimes return a custom lazily-loaded value type instead of the native Lua value. This custom type lazily constructs the
///     necessary value when <see cref="LuaLazyLoadedValue.Get" /> is called, therefore preventing its unnecessary construction in some cases.
