...
public abstract class LuaItemPrototype : LuaObject
{
  ...
  [FactorioRconAttribute("name")]
    ...
    public Literals947311345 FilterMode { get; private set; }

    /// <summary>
    ///     The insertion priority mode used by this item with inventory.
    /// </summary>
    [FactorioRconAttribute("insertion_priority_mode")]
    public Literals1958288421 InsertionPriorityMode { get; private set; }
    ...
    /// <summary>
    ///     The name of a <see cref="LuaModuleCategoryPrototype" />. Used when upgrading modules: Ctrl + click modules into an entity and it will replace lower tier modules of the same
    ...
    /// <summary>
    ///     Tier of the module inside its category. Used when upgrading modules: Ctrl + click modules into an entity and it will replace lower tier modules with higher tier modules if
    ...
    public abstract AmmoType? GetAmmoType(Literals1189537475? ammoSourceType = null);
