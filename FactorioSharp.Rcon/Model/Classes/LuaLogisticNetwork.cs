...
public abstract class LuaLogisticNetwork : LuaObject
{
  ...
  [FactorioRconMethod("get_item_count")]
    public abstract int GetItemCount(string? item = null, Literals1997830415? member = null);
  ...
  [FactorioRconMethod("remove_item")]
    public abstract uint RemoveItem(ItemStackIdentification item, Literals74191897? members = null);
  ...
  [FactorioRconMethod("insert")]
    public abstract uint Insert(ItemStackIdentification item, Literals1122877177? members = null);
  ...
  [FactorioRconMethod("select_pickup_point")]
    public abstract LuaLogisticPoint? SelectPickupPoint(string name, MapPosition? position = null, bool? includeBuffers = null, Literals339665519? members = null);
  ...
  [FactorioRconMethod("select_drop_point")]
    public abstract LuaLogisticPoint? SelectDropPoint(ItemStackIdentification stack, Literals1436172750? members = null);
