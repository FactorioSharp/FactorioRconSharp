...
public abstract class LuaAISettings : LuaObject
{
  ...
  /// <summary>
  ///     Defines how coarse the pathfinder's grid is, where smaller values mean a coarser grid. Defaults to `0`, which equals a resolution of `1x1` tiles, centered on tile centers.
  ///     Values range from `-8` to `8` inclusive, where each integer increment doubles/halves the resolution. So, a resolution of `-8` equals a grid of `256x256` tiles, and a
  ///     resolution of `8` equals `1/256` of a tile.
  /// </summary>
