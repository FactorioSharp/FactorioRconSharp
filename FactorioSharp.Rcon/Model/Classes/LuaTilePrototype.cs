...
public abstract class LuaTilePrototype : LuaObject
{
  ...
  [FactorioRconAttribute("order")]
    ...
    public Table1961989298 MineableProperties { get; private set; }
    ...
    /// <summary>
    ///     True if building this tile should check for colliding entities above and prevent building if such are found. Also during mining tiles above this tile checks for entities
    ///     colliding with this tile and prevents mining if such are found.
    /// </summary>
