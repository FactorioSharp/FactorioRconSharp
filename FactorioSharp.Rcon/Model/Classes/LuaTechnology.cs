...
public abstract class LuaTechnology : LuaObject
{
  ...
  [FactorioRconAttribute("localised_name")]
    ...
    /// <summary>
    ///     The current level of this technology. For level-based technology writing to this is the same as researching the technology to the previous level. Writing the level will set
    ///     <see cref="LuaTechnology.Enabled" /> to `true`.
    /// </summary>
