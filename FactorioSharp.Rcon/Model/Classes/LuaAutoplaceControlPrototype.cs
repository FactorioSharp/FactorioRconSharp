...
public abstract class LuaAutoplaceControlPrototype: LuaObject, IFactorioRconModel
{
  ...
  public bool Richness { get; private set; }

  [FactorioRconAttribute("can_be_disabled")]
  public bool CanBeDisabled { get; private set; }

  [FactorioRconAttribute("control_order")]
  public string ControlOrder { get; private set; }
