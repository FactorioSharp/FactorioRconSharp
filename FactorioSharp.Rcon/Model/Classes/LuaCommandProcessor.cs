...
/// <summary>
///     Allows for the registration of custom console commands through the global object named `commands`. Similarly to <see cref="LuaBootstrap.OnEvent" />, these don't persist
///     through a save-and-load cycle.
/// </summary>
