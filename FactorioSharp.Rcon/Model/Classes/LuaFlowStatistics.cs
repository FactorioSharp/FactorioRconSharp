...
public abstract class LuaFlowStatistics: LuaObject
{
  ...
  public Dictionary<string, Union1104138130> InputCounts { get; private set; }
  ...
  public Dictionary<string, Union1104138130> OutputCounts { get; private set; }
  ...
  public abstract Union1104138130 GetInputCount(string name);
  ...
  public abstract void SetInputCount(string name, Union1104138130 count);
  ...
  public abstract Union1104138130 GetOutputCount(string name);
  ...
  public abstract void SetOutputCount(string name, Union1104138130 count);
