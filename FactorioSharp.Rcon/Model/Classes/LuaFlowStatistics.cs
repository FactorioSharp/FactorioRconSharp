...
public abstract class LuaFlowStatistics: LuaObject
{
  ...
  public Dictionary<string, Union1732410965> InputCounts { get; private set; }
  ...
  public Dictionary<string, Union1732410965> OutputCounts { get; private set; }
  ...
  public abstract Union1732410965 GetInputCount(string name);
  ...
  public abstract void SetInputCount(string name, Union1732410965 count);
  ...
  public abstract Union1732410965 GetOutputCount(string name);
  ...
  public abstract void SetOutputCount(string name, Union1732410965 count);
