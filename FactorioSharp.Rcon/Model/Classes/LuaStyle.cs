...
public abstract class LuaStyle : LuaObject
{
  ...
  [FactorioRconAttribute("natural_height")]
    ...
    public Literals2090650904 HorizontalAlign { get; set; }

    /// <summary>
    ///     Vertical align of the inner content of the widget, if any.
    /// </summary>
    [FactorioRconAttribute("vertical_align")]
    public Literals2105617757 VerticalAlign { get; set; }
    ...
    /// <summary>
    ///     Whether the GUI element can be squashed (by maximal width of some parent element) horizontally. `nil` if this element does not support squashing. This is mainly meant to be
    ///     used for scroll-pane The default value is false.
    /// </summary>
    [FactorioRconAttribute("horizontally_squashable")]
    public bool HorizontallySquashable { get; set; }

    /// <summary>
    ///     Whether the GUI element can be squashed (by maximal height of some parent element) vertically. `nil` if this element does not support squashing. This is mainly meant to be
    ///     used for scroll-pane The default (parent) value for scroll pane is true, false otherwise.
    /// </summary>
    ...
    /// <summary>
    ///     Array containing the alignment for every column of this table element. Even though this property is marked as read-only, the alignment can be changed by indexing the
    ///     LuaCustomTable, like so:
    /// </summary>
    ...
    public Union859755215 Size { private get; set; }

    /// <summary>
    ///     Sets top/right/bottom/left paddings to this value. An array with two values sets top/bottom padding to the first value and left/right padding to the second value. An array
    ///     with four values sets top, right, bottom, left padding respectively.
    /// </summary>
    [FactorioRconAttribute("padding")]
    public Union859755215 Padding { private get; set; }

    /// <summary>
    ///     Sets top/right/bottom/left margins to this value. An array with two values sets top/bottom margin to the first value and left/right margin to the second value. An array with
    ///     four values sets top, right, bottom, left margin respectively.
    /// </summary>
    [FactorioRconAttribute("margin")]
    public Union859755215 Margin { private get; set; }
    ...
    /// <summary>
    ///     Sets `extra_top/right/bottom/left_padding_when_activated` to this value. An array with two values sets top/bottom padding to the first value and left/right padding to the
    ///     second value. An array with four values sets top, right, bottom, left padding respectively.
    /// </summary>
    [FactorioRconAttribute("extra_padding_when_activated")]
    public Union859755215 ExtraPaddingWhenActivated { private get; set; }

    /// <summary>
    ///     Sets `extra_top/right/bottom/left_margin_when_activated` to this value. An array with two values sets top/bottom margin to the first value and left/right margin to the second
    ///     value. An array with four values sets top, right, bottom, left margin respectively.
    /// </summary>
    [FactorioRconAttribute("extra_margin_when_activated")]
    public Union859755215 ExtraMarginWhenActivated { private get; set; }
