...
public class LuaForce
{
  ...
  public Dictionary<string, LuaLogisticNetwork[]> LogisticNetworks { get; private set; }
  ...
  public TechnologyIdentification[] ResearchQueue { get; set; }
  ...
  public uint GetEntityCount(string name) => throw FactorioModelUtils.UseClientReadAsyncMethod();

  /// <summary>
  /// Disable research for this force.
  /// </summary>
  [FactorioRconMethod("disable_research")]
  public void DisableResearch() => throw FactorioModelUtils.UseClientExecuteAsyncMethod();

  /// <summary>
  /// Enable research for this force.
  /// </summary>
  [FactorioRconMethod("enable_research")]
  public void EnableResearch() => throw FactorioModelUtils.UseClientExecuteAsyncMethod();
  ...
  public void DisableAllPrototypes() => throw FactorioModelUtils.UseClientExecuteAsyncMethod();
  ...
  public void EnableAllPrototypes() => throw FactorioModelUtils.UseClientExecuteAsyncMethod();

  /// <summary>
  /// Load the original version of all recipes from the prototypes.
  /// </summary>
  [FactorioRconMethod("reset_recipes")]
  public void ResetRecipes() => throw FactorioModelUtils.UseClientExecuteAsyncMethod();

  /// <summary>
  /// Unlock all recipes.
  /// </summary>
  [FactorioRconMethod("enable_all_recipes")]
  public void EnableAllRecipes() => throw FactorioModelUtils.UseClientExecuteAsyncMethod();

  /// <summary>
  /// Unlock all technologies.
  /// </summary>
  [FactorioRconMethod("enable_all_technologies")]
  public void EnableAllTechnologies() => throw FactorioModelUtils.UseClientExecuteAsyncMethod();
  ...
  public void ResearchAllTechnologies(bool? includeDisabledPrototypes = null) => throw FactorioModelUtils.UseClientExecuteAsyncMethod();
  ...
  public void ResetTechnologies() => throw FactorioModelUtils.UseClientExecuteAsyncMethod();
  ...
  public void ResetTechnologyEffects() => throw FactorioModelUtils.UseClientExecuteAsyncMethod();
  ...
  public void Chart(SurfaceIdentification surface, BoundingBox area) => throw FactorioModelUtils.UseClientExecuteAsyncMethod();
  ...
  public void ClearChart(SurfaceIdentification? surface = null) => throw FactorioModelUtils.UseClientExecuteAsyncMethod();
  ...
  public void Rechart(SurfaceIdentification? surface = null) => throw FactorioModelUtils.UseClientExecuteAsyncMethod();
  ...
  public void ChartAll(SurfaceIdentification? surface = null) => throw FactorioModelUtils.UseClientExecuteAsyncMethod();
  ...
  public bool IsChunkCharted(SurfaceIdentification surface, ChunkPosition position) => throw FactorioModelUtils.UseClientReadAsyncMethod();
  ...
  public bool IsChunkVisible(SurfaceIdentification surface, ChunkPosition position) => throw FactorioModelUtils.UseClientReadAsyncMethod();
  ...
  public bool IsChunkRequestedForCharting(SurfaceIdentification surface, ChunkPosition position) => throw FactorioModelUtils.UseClientReadAsyncMethod();
  ...
  public void CancelCharting(SurfaceIdentification? surface = null) => throw FactorioModelUtils.UseClientExecuteAsyncMethod();

  /// <param name="ammo">Lua name: ammo</param>
  [FactorioRconMethod("get_ammo_damage_modifier")]
  public double GetAmmoDamageModifier(string ammo) => throw FactorioModelUtils.UseClientReadAsyncMethod();

  /// <param name="ammo">Lua name: ammo</param>
  /// <param name="modifier">Lua name: modifier</param>
  [FactorioRconMethod("set_ammo_damage_modifier")]
  public void SetAmmoDamageModifier(string ammo, double modifier) => throw FactorioModelUtils.UseClientExecuteAsyncMethod();

  /// <param name="ammo">Lua name: ammo</param>
  [FactorioRconMethod("get_gun_speed_modifier")]
  public double GetGunSpeedModifier(string ammo) => throw FactorioModelUtils.UseClientReadAsyncMethod();

  /// <param name="ammo">Lua name: ammo</param>
  /// <param name="modifier">Lua name: modifier</param>
  [FactorioRconMethod("set_gun_speed_modifier")]
  public void SetGunSpeedModifier(string ammo, double modifier) => throw FactorioModelUtils.UseClientExecuteAsyncMethod();

  /// <param name="turret">Lua name: turret</param>
  [FactorioRconMethod("get_turret_attack_modifier")]
  public double GetTurretAttackModifier(string turret) => throw FactorioModelUtils.UseClientReadAsyncMethod();

  /// <param name="turret">Lua name: turret</param>
  /// <param name="modifier">Lua name: modifier</param>
  [FactorioRconMethod("set_turret_attack_modifier")]
  public void SetTurretAttackModifier(string turret, double modifier) => throw FactorioModelUtils.UseClientExecuteAsyncMethod();
  ...
  public void SetCeaseFire(ForceIdentification other, bool ceaseFire) => throw FactorioModelUtils.UseClientExecuteAsyncMethod();
  ...
  public bool GetCeaseFire(ForceIdentification other) => throw FactorioModelUtils.UseClientReadAsyncMethod();
  ...
  public void SetFriend(ForceIdentification other, bool friend) => throw FactorioModelUtils.UseClientExecuteAsyncMethod();
  ...
  public bool GetFriend(ForceIdentification other) => throw FactorioModelUtils.UseClientReadAsyncMethod();
  ...
  public bool IsPathfinderBusy() => throw FactorioModelUtils.UseClientReadAsyncMethod();

  /// <summary>
  /// Kill all units and flush the pathfinder.
  /// </summary>
  [FactorioRconMethod("kill_all_units")]
  public void KillAllUnits() => throw FactorioModelUtils.UseClientExecuteAsyncMethod();

  /// <param name="position">Lua name: position</param>
  /// <param name="surface">Lua name: surface</param>
  [FactorioRconMethod("find_logistic_network_by_position")]
  public LuaLogisticNetwork? FindLogisticNetworkByPosition(MapPosition position, SurfaceIdentification surface) => throw FactorioModelUtils.UseClientReadAsyncMethod();

  /// <param name="position">Lua name: position</param>
  /// <param name="surface">Lua name: surface</param>
  [FactorioRconMethod("set_spawn_position")]
  public void SetSpawnPosition(MapPosition position, SurfaceIdentification surface) => throw FactorioModelUtils.UseClientExecuteAsyncMethod();

  /// <param name="surface">Lua name: surface</param>
  [FactorioRconMethod("get_spawn_position")]
  public MapPosition GetSpawnPosition(SurfaceIdentification surface) => throw FactorioModelUtils.UseClientReadAsyncMethod();

  /// <param name="position">Lua name: position</param>
  /// <param name="surface">Lua name: surface</param>
  [FactorioRconMethod("unchart_chunk")]
  public void UnchartChunk(ChunkPosition position, SurfaceIdentification surface) => throw FactorioModelUtils.UseClientExecuteAsyncMethod();
  ...
  public uint GetItemLaunched(string item) => throw FactorioModelUtils.UseClientReadAsyncMethod();
  ...
  public void SetItemLaunched(string item, uint count) => throw FactorioModelUtils.UseClientExecuteAsyncMethod();
  ...
  public LuaTrain[] GetTrains(SurfaceIdentification? surface = null) => throw FactorioModelUtils.UseClientReadAsyncMethod();
  ...
  public LuaCustomChartTag? AddChartTag(SurfaceIdentification surface, ChartTagSpec tag) => throw FactorioModelUtils.UseClientReadAsyncMethod();
  ...
  public LuaCustomChartTag[] FindChartTags(SurfaceIdentification surface, BoundingBox? area = null) => throw FactorioModelUtils.UseClientReadAsyncMethod();
  ...
  public double? GetSavedTechnologyProgress(TechnologyIdentification technology) => throw FactorioModelUtils.UseClientReadAsyncMethod();
  ...
  public void SetSavedTechnologyProgress(TechnologyIdentification technology, double progress) => throw FactorioModelUtils.UseClientExecuteAsyncMethod();

  /// <summary>
  /// Resets evolution for this force to zero.
  /// </summary>
  [FactorioRconMethod("reset_evolution")]
  public void ResetEvolution() => throw FactorioModelUtils.UseClientExecuteAsyncMethod();
  ...
  public LuaEntity[] GetTrainStops(OneOf<string, string[]>? name = null, SurfaceIdentification? surface = null) => throw FactorioModelUtils.UseClientReadAsyncMethod();
  ...
  public bool GetHandCraftingDisabledForRecipe(OneOf<string, LuaRecipe> recipe) => throw FactorioModelUtils.UseClientReadAsyncMethod();
  ...
  public void SetHandCraftingDisabledForRecipe(OneOf<string, LuaRecipe> recipe, bool handCraftingDisabled) => throw FactorioModelUtils.UseClientExecuteAsyncMethod();
  ...
  public bool AddResearch(TechnologyIdentification technology) => throw FactorioModelUtils.UseClientReadAsyncMethod();
  ...
  public void CancelCurrentResearch() => throw FactorioModelUtils.UseClientExecuteAsyncMethod();
  ...
  public LuaInventory? GetLinkedInventory(EntityPrototypeIdentification prototype, uint linkId) => throw FactorioModelUtils.UseClientReadAsyncMethod();
  ...
  public bool IsFriend(ForceIdentification other) => throw FactorioModelUtils.UseClientReadAsyncMethod();
  ...
  public bool IsEnemy(ForceIdentification other) => throw FactorioModelUtils.UseClientReadAsyncMethod();
