...
public abstract class LuaItemPrototype: LuaObject
{
  ...
  public Literals1453543256 FilterMode { get; private set; }

  /// <summary>
  /// The insertion priority mode used by this item with inventory.
  /// </summary>
  [FactorioRconAttribute("insertion_priority_mode")]
  public Literals46136830 InsertionPriorityMode { get; private set; }
  ...
  public abstract AmmoType? GetAmmoType(Literals587189108? ammoSourceType = null);
