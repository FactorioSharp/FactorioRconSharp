...
public abstract class LuaItemPrototype: LuaObject
{
  ...
  public Literals1161313291 FilterMode { get; private set; }

  /// <summary>
  /// The insertion priority mode used by this item with inventory.
  /// </summary>
  [FactorioRconAttribute("insertion_priority_mode")]
  public Literals1504160613 InsertionPriorityMode { get; private set; }
  ...
  public abstract AmmoType? GetAmmoType(Literals1575309008? ammoSourceType = null);
