...
public abstract class LuaItemPrototype: LuaObject
{
  ...
  public Literals1545652026 FilterMode { get; private set; }

  /// <summary>
  /// The insertion priority mode used by this item with inventory.
  /// </summary>
  [FactorioRconAttribute("insertion_priority_mode")]
  public Literals1827453384 InsertionPriorityMode { get; private set; }
  ...
  public abstract AmmoType? GetAmmoType(Literals1807146525? ammoSourceType = null);
