...
public abstract class LuaFlowStatistics: LuaObject
{
  ...
  public Dictionary<string, Type375078767> InputCounts { get; private set; }
  ...
  public Dictionary<string, Type375078767> OutputCounts { get; private set; }
  ...
  public abstract Type375078767 GetInputCount(string name);
  ...
  public abstract void SetInputCount(string name, Type375078767 count);
  ...
  public abstract Type375078767 GetOutputCount(string name);
  ...
  public abstract void SetOutputCount(string name, Type375078767 count);
