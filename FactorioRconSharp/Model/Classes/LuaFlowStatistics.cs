...
public abstract class LuaFlowStatistics: LuaObject
{
  ...
  public Dictionary<string, Type1421203362> InputCounts { get; private set; }
  ...
  public Dictionary<string, Type1421203362> OutputCounts { get; private set; }
  ...
  public abstract Type1421203362 GetInputCount(string name);
  ...
  public abstract void SetInputCount(string name, Type1421203362 count);
  ...
  public abstract Type1421203362 GetOutputCount(string name);
  ...
  public abstract void SetOutputCount(string name, Type1421203362 count);
