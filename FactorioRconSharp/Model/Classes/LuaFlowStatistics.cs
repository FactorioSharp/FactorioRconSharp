...
public abstract class LuaFlowStatistics: LuaObject
{
  ...
  public Dictionary<string, Union146196962> InputCounts { get; private set; }
  ...
  public Dictionary<string, Union146196962> OutputCounts { get; private set; }
  ...
  public abstract Union146196962 GetInputCount(string name);
  ...
  public abstract void SetInputCount(string name, Union146196962 count);
  ...
  public abstract Union146196962 GetOutputCount(string name);
  ...
  public abstract void SetOutputCount(string name, Union146196962 count);
