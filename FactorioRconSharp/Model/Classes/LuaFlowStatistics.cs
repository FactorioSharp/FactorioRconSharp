...
public abstract class LuaFlowStatistics: LuaObject
{
  ...
  public Dictionary<string, Type1947253782> InputCounts { get; private set; }
  ...
  public Dictionary<string, Type1947253782> OutputCounts { get; private set; }
  ...
  public abstract Type1947253782 GetInputCount(string name);
  ...
  public abstract void SetInputCount(string name, Type1947253782 count);
  ...
  public abstract Type1947253782 GetOutputCount(string name);
  ...
  public abstract void SetOutputCount(string name, Type1947253782 count);
