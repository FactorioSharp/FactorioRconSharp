...
public abstract class LuaFlowStatistics: LuaObject
{
  ...
  public Dictionary<string, Union1567024678> InputCounts { get; private set; }
  ...
  public Dictionary<string, Union1567024678> OutputCounts { get; private set; }
  ...
  public abstract Union1567024678 GetInputCount(string name);
  ...
  public abstract void SetInputCount(string name, Union1567024678 count);
  ...
  public abstract Union1567024678 GetOutputCount(string name);
  ...
  public abstract void SetOutputCount(string name, Union1567024678 count);
