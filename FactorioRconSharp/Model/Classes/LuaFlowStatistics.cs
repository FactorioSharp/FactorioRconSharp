...
public abstract class LuaFlowStatistics: LuaObject
{
  ...
  public Dictionary<string, Union1609805708> InputCounts { get; private set; }
  ...
  public Dictionary<string, Union1609805708> OutputCounts { get; private set; }
  ...
  public abstract Union1609805708 GetInputCount(string name);
  ...
  public abstract void SetInputCount(string name, Union1609805708 count);
  ...
  public abstract Union1609805708 GetOutputCount(string name);
  ...
  public abstract void SetOutputCount(string name, Union1609805708 count);
