...
public abstract class LuaFlowStatistics: LuaObject
{
  ...
  public Dictionary<string, Union1772560632> InputCounts { get; private set; }
  ...
  public Dictionary<string, Union1772560632> OutputCounts { get; private set; }
  ...
  public abstract Union1772560632 GetInputCount(string name);
  ...
  public abstract void SetInputCount(string name, Union1772560632 count);
  ...
  public abstract Union1772560632 GetOutputCount(string name);
  ...
  public abstract void SetOutputCount(string name, Union1772560632 count);
