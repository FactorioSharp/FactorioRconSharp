...
public abstract class LuaItemStack: LuaObject
{
  ...
  public Literals1082214586 PrioritizeInsertionMode { get; set; }
  ...
  public abstract bool SetEntityFilter(uint index, Union2079168720 filter);
  ...
  public abstract bool SetTileFilter(uint index, Union234825571 filter);
  ...
  public abstract UpgradeFilter GetMapper(uint index, Literals177192641 type);
  ...
  public abstract void SetMapper(uint index, Literals1920437843 type, Union95096463 filter);
