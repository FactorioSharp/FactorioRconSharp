...
public abstract class LuaItemStack: LuaObject
{
  ...
  public Literals949241724 PrioritizeInsertionMode { get; set; }
  ...
  public abstract bool SetEntityFilter(uint index, Union1870632134 filter);
  ...
  public abstract bool SetTileFilter(uint index, Union1101147407 filter);
  ...
  public abstract UpgradeFilter GetMapper(uint index, Literals2098791602 type);
  ...
  public abstract void SetMapper(uint index, Literals1767175160 type, Union794279298 filter);
