...
public abstract class LuaItemStack: LuaObject
{
  ...
  public Literals2015130325 PrioritizeInsertionMode { get; set; }
  ...
  public abstract bool SetEntityFilter(uint index, Union885218260 filter);
  ...
  public abstract bool SetTileFilter(uint index, Union425547432 filter);
  ...
  public abstract UpgradeFilter GetMapper(uint index, Literals419206503 type);
  ...
  public abstract void SetMapper(uint index, Literals293235054 type, Union103331503 filter);
