...
public class LuaShortcutPrototype
{
  /// <summary>
  ...
  /// </summary>
  [FactorioRconAttribute("technology_to_unlock")]
  public LuaTechnologyPrototype TechnologyToUnlock { get; private set; }

  [FactorioRconAttribute("toggleable")]
  public bool Toggleable { get; private set; }

  /// <summary>
  /// The control input that is associated with this shortcut, if any.
  /// </summary>
  [FactorioRconAttribute("associated_control_input")]
  public string AssociatedControlInput { get; private set; }
