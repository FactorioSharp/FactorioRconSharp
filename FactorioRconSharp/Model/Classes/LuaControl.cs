...
public abstract class LuaControl: LuaObject
{
  ...
  public Union1105745623 Opened { get; set; }
  ...
  public Table1805000526 WalkingState { get; set; }
  ...
  public Table620828956 MiningState { get; set; }

  /// <summary>
  /// Current shooting state.
  /// </summary>
  [FactorioRconAttribute("shooting_state")]
  public Table883258584 ShootingState { get; set; }
  ...
  public Table427872281 RepairState { get; set; }
  ...
  public abstract uint GetCraftableCount(Union1430494584 recipe);
  ...
  public abstract uint BeginCrafting(uint count, Union1430494584 recipe, bool? silent = null);
