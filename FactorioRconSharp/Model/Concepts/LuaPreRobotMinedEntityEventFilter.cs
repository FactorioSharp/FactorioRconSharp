...
/// </summary>
[FactorioRconConcept("LuaPreRobotMinedEntityEventFilter")]
public abstract class LuaPreRobotMinedEntityEventFilter
{
  /// <summary>
  ...
  public Union2714736 Mode { get; set; }
...
public abstract class Table5514630
{
  /// <summary>
  /// The condition to filter on. One of `"ghost"`, `"rail"`, `"rail-signal"`, `"rolling-stock"`, `"robot-with-logistics-interface"`, `"vehicle"`, `"turret"`, `"crafting-machine"`, `"wall-connectable"`, `"transport-belt-connectable"`, `"circuit-network-connectable"`, `"type"`, `"name"`, `"ghost_type"`, `"ghost_name"`.
  /// </summary>
...
[GenerateOneOf]
public abstract partial class Union2714736: OneOfBase<Literal33336387, Literal25486770>
{
}
...
/// Literal value: or
/// </summary>
public abstract class Literal33336387
{
  /// <summary>
  /// Literal value: or
  /// </summary>
...
/// Literal value: and
/// </summary>
public abstract class Literal25486770
{
  /// <summary>
  /// Literal value: and
  /// </summary>
