...
/// </summary>
[FactorioRconConcept("LuaPlayerRepairedEntityEventFilter")]
public abstract class LuaPlayerRepairedEntityEventFilter
{
  /// <summary>
  ...
  public Union6134445 Mode { get; set; }
...
public abstract class Table65460906
{
  /// <summary>
  /// The condition to filter on. One of `"ghost"`, `"rail"`, `"rail-signal"`, `"rolling-stock"`, `"robot-with-logistics-interface"`, `"vehicle"`, `"turret"`, `"crafting-machine"`, `"wall-connectable"`, `"transport-belt-connectable"`, `"circuit-network-connectable"`, `"type"`, `"name"`, `"ghost_type"`, `"ghost_name"`.
  /// </summary>
...
[GenerateOneOf]
public abstract partial class Union6134445: OneOfBase<Literal25647901, Literal9448253>
{
}
...
/// Literal value: or
/// </summary>
public abstract class Literal25647901
{
  /// <summary>
  /// Literal value: or
  /// </summary>
...
/// Literal value: and
/// </summary>
public abstract class Literal9448253
{
  /// <summary>
  /// Literal value: and
  /// </summary>
