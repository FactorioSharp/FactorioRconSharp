...
/// </summary>
[FactorioRconConcept("LuaEntityMarkedForUpgradeEventFilter")]
public abstract class LuaEntityMarkedForUpgradeEventFilter
{
  /// <summary>
  ...
  public Union52645020 Mode { get; set; }
...
public abstract class Table25001628
{
  /// <summary>
  /// The condition to filter on. One of `"ghost"`, `"rail"`, `"rail-signal"`, `"rolling-stock"`, `"robot-with-logistics-interface"`, `"vehicle"`, `"turret"`, `"crafting-machine"`, `"wall-connectable"`, `"transport-belt-connectable"`, `"circuit-network-connectable"`, `"type"`, `"name"`, `"ghost_type"`, `"ghost_name"`.
  /// </summary>
...
[GenerateOneOf]
public abstract partial class Union52645020: OneOfBase<Literal1708691, Literal63221586>
{
}
...
/// Literal value: or
/// </summary>
public abstract class Literal1708691
{
  /// <summary>
  /// Literal value: or
  /// </summary>
...
/// Literal value: and
/// </summary>
public abstract class Literal63221586
{
  /// <summary>
  /// Literal value: and
  /// </summary>
