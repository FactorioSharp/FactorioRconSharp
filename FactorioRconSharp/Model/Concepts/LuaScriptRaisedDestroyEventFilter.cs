...
/// </summary>
[FactorioRconConcept("LuaScriptRaisedDestroyEventFilter")]
public abstract class LuaScriptRaisedDestroyEventFilter
{
  /// <summary>
  ...
  public Union22868227 Mode { get; set; }
...
public abstract class Table24196850
{
  /// <summary>
  /// The condition to filter on. One of `"ghost"`, `"rail"`, `"rail-signal"`, `"rolling-stock"`, `"robot-with-logistics-interface"`, `"vehicle"`, `"turret"`, `"crafting-machine"`, `"wall-connectable"`, `"transport-belt-connectable"`, `"circuit-network-connectable"`, `"type"`, `"name"`, `"ghost_type"`, `"ghost_name"`.
  /// </summary>
...
[GenerateOneOf]
public abstract partial class Union22868227: OneOfBase<Literal40818040, Literal33872503>
{
}
...
/// Literal value: or
/// </summary>
public abstract class Literal40818040
{
  /// <summary>
  /// Literal value: or
  /// </summary>
...
/// Literal value: and
/// </summary>
public abstract class Literal33872503
{
  /// <summary>
  /// Literal value: and
  /// </summary>
