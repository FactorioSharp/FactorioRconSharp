...
/// </summary>
[FactorioRconConcept("LuaEntityClonedEventFilter")]
public abstract class LuaEntityClonedEventFilter
{
  /// <summary>
  ...
  public Union39346072 Mode { get; set; }
...
public abstract class Table21014691
{
  /// <summary>
  /// The condition to filter on. One of `"ghost"`, `"rail"`, `"rail-signal"`, `"rolling-stock"`, `"robot-with-logistics-interface"`, `"vehicle"`, `"turret"`, `"crafting-machine"`, `"wall-connectable"`, `"transport-belt-connectable"`, `"circuit-network-connectable"`, `"type"`, `"name"`, `"ghost_type"`, `"ghost_name"`.
  /// </summary>
...
[GenerateOneOf]
public abstract partial class Union39346072: OneOfBase<Literal46518529, Literal43464004>
{
}
...
/// Literal value: or
/// </summary>
public abstract class Literal46518529
{
  /// <summary>
  /// Literal value: or
  /// </summary>
...
/// Literal value: and
/// </summary>
public abstract class Literal43464004
{
  /// <summary>
  /// Literal value: and
  /// </summary>
