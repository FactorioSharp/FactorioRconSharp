...
/// Another key difference is that custom tables cannot be serialised into a game save file -- if saving the game would require serialisation of a custom table, an error will be displayed and the game will not be saved.
/// </summary>
public class LuaCustomTable<TKey, TValue>: FactorioRconModelBase
{
        /// <summary>
        ...
        /// </summary>
        public TValue this[TKey key] { get => throw UseClientReadAsyncMethod(); set => throw UseClientExecuteAsyncMethod();}
        
        /// <summary>
        /// All methods and properties that this object supports.
        /// </summary>
        [FactorioRconMethod("help")]
        public string Help() => throw UseClientReadAsyncMethod();
}
